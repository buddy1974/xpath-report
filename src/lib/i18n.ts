...
export const STRINGS = {
  ...
  // DL-054 — Announcements / news ticker (administrator-authored only).
  announcementsNavTitle: { en: "Announcements", fr: "Annonces" },
  announcementsHeading: { en: "Announcements", fr: "Annonces" },
  announcementsBody: {
    en: "Broadcast to everyone in the lab. Never a channel for clinical guidance — that stays in templates, the protocol library, and reflex testing.",
    fr: "Diffusé à tout le laboratoire. Jamais un canal pour des consignes cliniques — celles-ci restent dans les modèles, la bibliothèque de protocoles et les tests réflexes.",
  },
  announcementTitleLabel: { en: "Title", fr: "Titre" },
  announcementCategoryLabel: { en: "Category", fr: "Catégorie" },
  announcementCategoryNews: { en: "News", fr: "Actualité" },
  announcementCategoryOperational: { en: "Operational", fr: "Opérationnel" },
  announcementCategoryEmergency: { en: "Emergency", fr: "Urgence" },
  announcementTickerEnLabel: { en: "Ticker text (English)", fr: "Texte du bandeau (anglais)" },
  announcementTickerFrLabel: { en: "Ticker text (French)", fr: "Texte du bandeau (français)" },
  announcementBodyEnLabel: { en: "Full detail (English)", fr: "Détail complet (anglais)" },
  announcementBodyFrLabel: { en: "Full detail (French)", fr: "Détail complet (français)" },
  announcementLinkLabel: { en: "Link (optional)", fr: "Lien (optionnel)" },
  announcementPublishNowLabel: { en: "Publish now", fr: "Publier maintenant" },
  announcementDurationLabel: { en: "Visible for", fr: "Visible pendant" },
  announcementDuration1Day: { en: "1 day", fr: "1 jour" },
  announcementDuration1Week: { en: "1 week", fr: "1 semaine" },
  announcementDuration1Month: { en: "1 month", fr: "1 mois" },
  announcementDurationCustom: { en: "Custom date", fr: "Date personnalisée" },
  announcementDurationIndefinite: { en: "Indefinite", fr: "Indéfini" },
  announcementSaveButton: { en: "Save", fr: "Enregistrer" },
  announcementNewButton: { en: "New announcement", fr: "Nouvelle annonce" },
  announcementEditLink: { en: "Edit", fr: "Modifier" },
  announcementUnpublishButton: { en: "Unpublish", fr: "Dépublier" },
  announcementStatusDraft: { en: "Draft", fr: "Brouillon" },
  announcementStatusPublished: { en: "Published", fr: "Publié" },
  announcementsEmpty: { en: "No announcements yet.", fr: "Aucune annonce pour l'instant." },
  announcementDismiss: { en: "Dismiss", fr: "Ignorer" },
  announcementDetailBackLink: { en: "← Back", fr: "← Retour" },

  // DL-054 — Super-admin account management.
  accountsNavTitle: { en: "Accounts", fr: "Comptes" },
  accountsHeading: { en: "Accounts", fr: "Comptes" },
  accountsBody: {
    en: "Full profile/status management for every account. Never reaches into a pathologist's private workspace or a signed clinical record (Header G2) — those aren't queried here at all.",
    fr: "Gestion complète du profil et du statut de chaque compte. N'accède jamais à l'espace de travail privé d'un pathologiste ni à un compte rendu clinique signé (Header G2) — ceux-ci ne sont jamais interrogés ici.",
  },
  accountNameLabel: { en: "Name", fr: "Nom" },
  accountEmailLabel: { en: "Email", fr: "E-mail" },
  accountUnitLabel: { en: "Unit / department", fr: "Unité / service" },
  accountPhoneLabel: { en: "Phone", fr: "Téléphone" },
  accountRoleLabel: { en: "Role", fr: "Rôle" },
  accountStatusLabel: { en: "Status", fr: "Statut" },
  accountStatusActive: { en: "Active", fr: "Actif" },
  accountStatusSuspended: { en: "Suspended", fr: "Suspendu" },
  accountStatusBlocked: { en: "Blocked", fr: "Bloqué" },
  accountStatusDeactivated: { en: "Deactivated", fr: "Désactivé" },
  accountSaveButton: { en: "Save changes", fr: "Enregistrer les modifications" },
  accountEditLink: { en: "Edit", fr: "Modifier" },
  accountSuspendButton: { en: "Suspend", fr: "Suspendre" },
  accountBlockButton: { en: "Block", fr: "Bloquer" },
  accountReactivateButton: { en: "Reactivate", fr: "Réactiver" },
  accountDeactivateButton: { en: "Deactivate", fr: "Désactiver" },
  accountConfirmBlock: {
    en: "Block this account? They will not be able to sign in until reactivated.",
    fr: "Bloquer ce compte ? La personne ne pourra plus se connecter tant qu'elle n'est pas réactivée.",
  },
  accountConfirmDeactivate: {
    en: "Deactivate this account? This is a soft-delete — the account and its authorship on any signed records are preserved, but it can only be brought back manually.",
    fr: "Désactiver ce compte ? Il s'agit d'une suppression douce — le compte et son statut d'auteur sur les comptes rendus signés sont conservés, mais il ne peut être réactivé que manuellement.",
  },

  // DL-054 — Admin-editable default content.
  contentAdminNavTitle: { en: "Content", fr: "Contenu" },
  contentAdminHeading: { en: "Default content", fr: "Contenu par défaut" },
  contentAdminBody: {
    en: "Template titles/blurbs/section titles and the Reflex Testing preview text. Saving here is the director-approval step (Header G3) — changes are versioned, audit-logged, and live immediately for new reports. Already-signed clinical records are never affected.",
    fr: "Titres/résumés de modèles, titres de sections, et le texte de l'aperçu Tests réflexes. Enregistrer ici constitue l'étape d'approbation par la direction (Header G3) — les modifications sont versionnées, journalisées, et actives immédiatement pour les nouveaux comptes rendus. Les comptes rendus cliniques déjà signés ne sont jamais affectés.",
  },
  contentValueLabel: { en: "Content", fr: "Contenu" },
  contentDirectorNoteLabel: { en: "Director's note (optional — shown to pathologists as context)", fr: "Note de la direction (optionnel — affichée aux pathologistes comme contexte)" },
  contentEditLink: { en: "Edit", fr: "Modifier" },
  contentSaveButton: { en: "Save", fr: "Enregistrer" },
  ...
  reagentAlertsHeading: { en: "Needs attention", fr: "À surveiller" },
  reagentAntibodiesGroupHeading: { en: "Antibody register", fr: "Registre d'anticorps" },
  reagentEquipmentGroupHeading: { en: "Equipment", fr: "Équipement" },
  reagentCloneLabel: { en: "Clone", fr: "Clone" },
  reagentCatalogueRefLabel: { en: "Catalogue ref.", fr: "Réf. catalogue" },
  reagentVendorLabel: { en: "Vendor", fr: "Fournisseur" },
  reagentLastRestockedLabel: { en: "Last restocked", fr: "Dernier réapprovisionnement" },
  reagentLastCalibratedLabel: { en: "Last calibrated", fr: "Dernier étalonnage" },
  reagentCalibrationIntervalLabel: { en: "Calibration interval (days)", fr: "Intervalle d'étalonnage (jours)" },
  reagentDueSoonBadge: { en: "Due soon", fr: "Bientôt dû" },
  reagentNotRecordedLabel: { en: "Not yet recorded", fr: "Pas encore enregistré" },
  reagentUnitsLabel: { en: "units", fr: "unités" },
  reagentRegisterBadge: { en: "Register item", fr: "Élément du registre" },
